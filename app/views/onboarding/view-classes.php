<div class="onboarding-container">
    <div class="hero-section-step2">
        <button class="back-btn" onclick="window.location.href='/onboarding/browse-plans';">
        ...
        <div class="content-wrapper">
            ...
            <div class="main-content-area">
                ...
                <div class="buttons-container-step2">
                    ...
                    <button class="btn btn-skip" onclick="window.location.href='/onboarding/view-store';">SKIP FOR NOW</button>
                </div>
            </div>
...
<style>
    ...
    .hero-section-step2 {
        ...
        background:
            ...
            url('https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=1470&auto=format&fit=crop') center/cover no-repeat;
    }
